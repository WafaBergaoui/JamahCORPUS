// local imgs
const Logo = require("../assets/imgs/jamahCORPUS-logo.png");
const ProfileBackground = require("../assets/imgs/profile-screen-bg.png");
const AuthBackground = require("../assets/imgs/yLOOp.jpg");
const JamahCORPUSLogo = require("../assets/imgs/jamahCORPUSlogo.png");
